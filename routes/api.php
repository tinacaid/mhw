...
//Route::middleware('jwt.role:administrator')->post('/teacher/logout', [TeacherController::class, 'logout']);

Route::middleware('jwt.role:administrator')->prefix('administrator')->group(function () {
...
//Route::middleware('auth:administrator')->get('/search', [WdwController::class, 'search']);
